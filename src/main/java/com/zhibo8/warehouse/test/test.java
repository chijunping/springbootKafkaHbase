...
import com.zhibo8.warehouse.taskTimer.AccessLogCleanTimer;
...
public class test {
    ...
    public void createKafaTopic() {
        ...
        AdminUtils.createTopic(zkUtils, "appLog", 40, 2, new Properties(), RackAwareMode.Enforced$.MODULE$);
        zkUtils.close();
    }
    ...
    public void deleteKafaTopic() {
        ZkUtils zkUtils = ZkUtils.apply(zkHost, 30000, 30000, JaasUtils.isZkSecurityEnabled());
        // 删除topic 't1'
        AdminUtils.deleteTopic(zkUtils, "appLog");
        zkUtils.close();
    }
...
// 修改topic 'test'的属性
    ...
    public void testEncrypt() {
        String encrypt = SecurityUtils.encrypt("{}", SecurityUtils.key);
