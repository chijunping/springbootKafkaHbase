 ...
 */
public class HBaseUtil_Online {

    private static final Logger logger = LoggerFactory.getLogger(HBaseUtil_Online.class);
...
//	}
    ...
    public static HTable getHtable(String tableName) {
        return (HTable) getTable(tableName);
    }
...
//	}
    ...
    public static void deleteFamily(String tableName) throws IOException {
